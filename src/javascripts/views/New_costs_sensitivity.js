window.twentyfifty.views.costs_sensitivity = function() {
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
    ...
    costsSensitivityHTML = "<div class='costssensitivity'>\n  <ul id='comparatorchoice'>\n    <li>\n      <a href=\"#\" onclick=\"$('ul#view_comparatorchoice').toggle(); return false;\">Choose comparison<img alt=\"Dropdown-arrow\" src=\"/assets/images/dropdown-arrow.png\" /></a>\n      <ul class='choices' id='view_comparatorchoice'>\n        <li><a href=\"#\" onclick=\"twentyfifty.switchComparator('11111111110111110011111110110111110110111');$('ul#view_comparatorchoice').toggle(); return false;\">Doesn't tackle climate change (All level 1)</a></li>\n        <li><a href=\"#\" onclick=\"twentyfifty.switchComparator('11111111111011111004444444044044444044333');$('ul#view_comparatorchoice').toggle(); return false;\">Maximum demand</a></li>\n        <li><a href=\"#\" onclick=\"twentyfifty.switchComparator('444444444440444440011111110110111110110111');$('ul#view_comparatorchoice').toggle(); return false;\">Maximum supply</a></li>\n        <li><a href=\"#\" onclick=\"twentyfifty.switchComparator('222222222220132120022221110210221210420111');$('ul#view_comparatorchoice').toggle(); return false;\">Analogous to MAED and MESSAGE</a></li>\n        <li><a href=\"#\" onclick=\"twentyfifty.switchComparator('22122433333012212001111111011111110420111');$('ul#view_comparatorchoice').toggle(); return false;\">Higher renewables, more energy efficiency</a></li>\n        <li><a href=\"#\" onclick=\"twentyfifty.switchComparator('111111111110142330011111110110111110220111');$('ul#view_comparatorchoice').toggle(); return false;\">Introducing nuclear energy into the power mix</a></li>\n        <li><a href=\"#\" onclick=\"twentyfifty.switchComparator('112111111110132130011111110110111110310111');$('ul#view_comparatorchoice').toggle(); return false;\">Introducing Coal energy, more bioenergy</a></li>\n        <li><a href=\"#\" onclick=\"twentyfifty.switchComparator('111111111110132120011111110110111110410111');$('ul#view_comparatorchoice').toggle(); return false;\">Low cost pathway to be discussed?</a></li>\n        <li><a href=\"#\" onclick=\"twentyfifty.switchComparator('222222222220124110011111110110111110420111');$('ul#view_comparatorchoice').toggle(); return false;\">Friends of the Environment</a></li>\n        <li><a href=\"#\" onclick=\"twentyfifty.switchComparator('221221121210123120011111110110111110410111');$('ul#view_comparatorchoice').toggle(); return false;\">Campaign to Protect Rural Nigeria</a></li>\n        <li><a href=\"#\" onclick=\"twentyfifty.switchComparator('333333333330334310011111110110111110420111');$('ul#view_comparatorchoice').toggle(); return false;\">Ministry of Power</a></li>\n        <li><a href=\"#\" onclick=\"twentyfifty.switchComparator('323222332220132220011111110110111110320111');$('ul#view_comparatorchoice').toggle(); return false;\">Transmission Company of Nigeria</a></li>\n     <li><a href="\#\" onclick=\"twentyfifty.switchComparator('222221111110134110011111110110111110420111');$('ul#view_comparatorchoice').toggle(); return false;\">National Planning Commission</a></li>\n      <li><a href="\#\" onclick=\"twentyfifty.switchComparator('1111111111101111100111111101101111110110111');$('ul#view_comparatorchoice').toggle(); return false;\">Federal Ministry of Environment</a></li>\n      </ul>\n    </li>\n  </ul>\n  <h1>The cost of your pathway compared with another, allowing simple variation in cost estimates.</h1>\n  <div id='costssensitivity'></div>\n  " + window.costEssentialNotesHTML + "\n</div>";

    bottom_area_start = 219;

    cost_component_names = ["Natural gas power plant", "Biomass power station", "Coal power station", "Nuclear power", "Wind", "Large Hydroelectric power stations", "Small Hydroelectric power stations", "Grid connected solar PV", "Concentrated solar power", "Stand-Alone Solar PV", "Biomatter to fuel conversion", "Bioenergy imports", "Agriculture and land use", "Energy from waste", "Volume of Waste & Recycling", "Electricity imports", "Electricity Exports", "Electricity grid distribution", "Residential Cooling", "Service Sector Cooling", "Residential Lighting, Appliances, and Cooking", "Service Sector Lighting, Appliances, and Cooking", "Industrial processes", "Conventional cars and buses ICE-LH", "Hybrid cars and buses", "Electric cars and buses", "Conventional cars and buses ICE-GH", "Bikes", "Rail", "Domestic aviation", "Domestic freight", "Petroleum refineries", "Indigenous fossil-fuel production - Coal", "Indegenous fossil-fuel production - Oil", "Indegenous fossil-fuel production - Gas", "Fossil fuel transfers", "Balancing imports - Coal", "Balancing imports - Oil", "Balancing imports - Gas", "Coal", "Oil", "Gas", "Finance cost"];
    ...
    this.drawChart = function() {
      ...
      r.text(x(5000), 17, "The mean cost to society of the whole energy system in undiscounted real Naira per person 2010-2050").attr({
        'text-anchor': 'center',
        'font-weight': 'bold'
      });
