window.twentyfifty.views.primary_energy_chart = function() {
  ...
  this.updateResults = function(pathway) {
    ...
    if(pathway.primary_energy_supply[pathway.primary_energy_supply.length-1][0] == "Total used in Nigeria") {
    ...
    t.transition().tween('text', function(d) {
      ...
      return function(t) {
        return this.textContent = "" + (i(t)) + "% percentage change compared to 2010"; //  reduction 1990-2050; Target is 80%";
      };
    });
...
//This section is for the Target Drawn on the chart: It can be uncommented if needed in the future
/*
