window.twentyfifty.views.sankey = function() {
    ...
    name_conversions = {
      "Nigeria land based bioenergy": "Forests & biocrops",
      "Bio-conversion": "Biomass processing",
      "H2 conversion": "Hydrogen production",
      "H2": "Hydrogen",
      "Useful district heat": "Delivered heat",
      "Cooling - residentials": "Home cooling",
      "Cooling - service sectors": "Office cooling",
      "Lighting, appliances & cooking - residential": "Home lighting, appliances & cooking",
      "Lighting, appliances & cooking - service sectors": "Office lighting, appliances & cooking"
    };
    ...
    this.setup = function() {
      ...
      this.s = s = new Sankey();
      s.stack(0, ["Solar", "Wind", "Hydro", "Traditional Fuel", "Electricity imports", "Nuclear", "Coal reserves", "Coal imports", "Biomass imports", "Gas reserves", "Gas imports", "Oil reserves", "Oil imports", "Biofuel imports", "Nigeria land based bioenergy", "Agricultural 'waste'", "Other waste", "Marine algae"]);
      s.stack(1, ["Coal"], "Coal reserves");
      s.stack(1, ["Natural Gas"], "Gas reserves");
      s.stack(1, ["Oil"], "Oil reserves");
      s.stack(1, ["Bio-conversion"], "Nigeria land based bioenergy");
      s.stack(2, ["Solar Technologies", "Electricity Grid"], "Solar");
      s.stack(2, ["Solid", "Gas", "Liquid"], "Coal");
      s.stack(3, ["Thermal generation", "Electricity Grid"], "Nuclear");
      s.stack(4, ["Electricity grid", "Residential cooling"], "Wind");
      s.stack(5, ["Electricity Grid"], "Hydro");
      s.stack(6, ["Residential Cooking, Lighting & Appliances", "Service Sector Lighting, Appliances & Cooking", "Industry"], "Traditional Fuel");
      s.stack(7, ["Residential Cooling", "Service Sector Cooling", "Residential Cooking, Lighting & Appliances", "Service Sector Lighting, Appliances & Cooking", "Industry", "Agriculture", "Road transport", "Rail transport", "Domestic aviation", "Berge", "Pipeline", "Over generation / exports", "Losses"]);
